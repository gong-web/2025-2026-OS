...
struct kmem_cache; // Forward declaration for SLUB
...
struct Page
{
    ...
    // SLUB fields
    struct kmem_cache *slab_cache;  // cache that owns this page
    void *freelist;                 // free objects list in this page
    void *s_mem;                    // first object address
    unsigned int inuse;             // used objects count
    unsigned int objects;           // total objects count
};
