...
![image-20251212004907767](assets/image-20251212004907767.png)

**状态观测（执行 `ecall` 前）：** 此时处于 User Mode。尝试读取特权寄存器 `scause` 会失败，验证了权限隔离。

![image-20251212012411780](assets/image-20251212012411780.png)
...
### **QEMU 的核心机制：TCG (Tiny Code Generator)**
