...
struct Page {
    ...
    // SLUB allocator fields (used when PG_slab flag is set)
    void *s_mem;                    // slab: first object address
    void *freelist;                 // slab: head of free object list
    unsigned short inuse;           // slab: number of allocated objects
    unsigned short objects;         // slab: total number of objects
    struct kmem_cache *slab_cache;  // slab: pointer to owning cache
};
